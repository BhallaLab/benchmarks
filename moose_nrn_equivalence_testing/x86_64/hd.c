...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 1);
 	...
 	ivoc_help("help ?1 hd /home_local/dilawars/Work/BhallaLab/benchmarks/moose_nrn_equivalence_testing/x86_64/hd.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 51 in file hd.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
